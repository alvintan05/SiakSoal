      ...
      <div class="card">
        ...
        <form action="<?php echo base_url(). 'dosen/edit_upload' ?>" method="post" enctype="multipart/form-data" >
          <div class="card-body">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <select id="utsuas" class="form-control" name="utsuas" disabled>
              ...
              <div class="form-group col-md-4">
                ...
                <select id="kbk" class="form-control" name="kbk">                  
                  <option value="KBK RPL" <?php echo set_select('kbk', 'kbkRPL', (!empty($kbk) && $kbk == "KBK RPL" ? TRUE: FALSE)); ?>>KBK RPL</option>
                  <option value="KBK Multimedia" <?php echo set_select('kbk', 'kbkMultimedia', (!empty($kbk) && $kbk == "KBK Multimedia" ? TRUE: FALSE)); ?>>KBK Multimedia</option>
                  <option value="KBK Character Building dan K3" <?php echo set_select('kbk', 'kbkCB', (!empty($kbk) && $kbk == "KBK Character Building dan K3" ? TRUE: FALSE)); ?>>KBK Character Building dan K3</option>
                  <option value="KBK Jaringan dan Embedded" <?php echo set_select('kbk', 'kbkJE', (!empty($kbk) && $kbk == "KBK Jaringan dan Embedded" ? TRUE: FALSE)); ?>>KBK Jaringan dan Embedded</option>
                </select>
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="card-footer" align="right">
            <a href="
              <?php 
                if(!empty($jenis_ujian) && $jenis_ujian == "UTS"){
                  echo site_url('dosen/status_soal_uts');
                }
                if(!empty($jenis_ujian) && $jenis_ujian == "UAS"){
                  echo site_url('dosen/status_soal_uas');
                }
              ?>
            ">
              <input class="btn btn-danger" type="button" name="kembali" value="Kembali">
            </a>
                &nbsp;
